    ...
    var mailOptions = {
        ...
        <body>
            <div class="message">
                ...
                issue with the details, please get in touch asap and our friendly staff
...
orderSchema.pre('remove', function(next) {
    // When the customer cancels an order, an email of 
    // the cancellation  should be sent to the customer
    var order = this;
    ...
    var mailOptions = {
        from: process.env.EMAIL,
        to: order.email,
        subject: `Your JJFresh Order Cancellation (#${order._id})`,
        html: `<!DOCTYPE html>
        <html>
        <head>
            <style>
        ...
        <body>
            <div class="message">
                <p>Hi there! Your order with JJFresh has been <strong>cancelled</strong>.
                Please retain this cancellation information for your records.</p>
                                       
            </div>
            
            <div class="order-details">
                <h4>Order Details</h4>
                <p>Your <strong>order ID #${order._id}</strong> has been cancelled.
                Here are the details of what you ordered:</p>
                <table id="items">
                    <tr>
                        <th>Qty</th>
                        <th>Item</th>
            ...
            <br/>
            <div>
                <p>If you have changed your mind or do not wish to cancel this order, please
                get into contact with our friendy staff or create a new order.</p>
            </div>
            <br/>
            <div>
                <p>Until next time, the team at JJFresh.
            </div>
        </body>
        </html>`
    }
